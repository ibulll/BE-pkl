    ...
    public function store(Request $request)
{
    try {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'file_portofolio' => 'nullable|file|mimes:pdf',
        ]);
        ...
        // Periksa apakah pengguna memiliki peran siswa (role_id = 4)
        if ($user->role_id !== 4) {
            return response()->json(['error' => 'Anda tidak memiliki izin untuk melakukan pengajuan PKL'], 403);
        }
